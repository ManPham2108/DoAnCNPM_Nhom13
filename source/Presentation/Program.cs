    ...
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            using (var serviceScope = host.Services.CreateScope())
            {
                ...
                try
                {
                    var PlaneAirContext = services.GetRequiredService<PlaneAirContext>();

                    IUnitOfWork unit = new UnitOfWork(PlaneAirContext);
                    ...
                    PlaneAirContext.SaveChanges();
                    DataSeed.Initialize(PlaneAirContext);
